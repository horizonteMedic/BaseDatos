...
CREATE OR REPLACE FUNCTION editar_anexo7c(IN p_norden integer)
  RETURNS TABLE(dni_cod_pa integer, nombres_nombres_pa text, apellidos_apellidos_pa text, fechanacimientopaciente_fecha_nacimiento_pa date, sexo_sexo_pa "char", lugarnacimientopaciente_lugar_nac_pa text, direccionpaciente_direccion_pa text, telefonocasapaciente_tel_casa_pa text, celularpaciente_cel_pa text, estadocivilpaciente_estado_civil_pa text, nivelestudiopaciente_nivel_est_pa text, empresa_razon_empresa text, contrata_razon_contrata text, nombreexamen_nom_examen text, explotacion_nom_ex text, altura_altura_po text, mineral_mineral_po text, cargo_cargo_de text, areaocupacional_area_o text, hijosvivosantecedentes_txtvhijosvivos text, hijosfallecidosantecedentes_txtvhijosfallecidos text, detallehijosvivosantecedentes_txtdhijosvivos text, detallehijosfallecidosantecedentes_txtdhijosfallecidos text, tallatriaje_talla text, pesotriaje_peso text, imctriaje_imc text, sistolicatriaje_sistolica text, diastolicatriaje_diastolica text, frecuenciarespiratoriatriaje_f_respiratoria text, frecuenciacardiacatriaje_f_cardiaca text, saturacionoxigenotriaje_sat_02 text, temperaturatriaje_temperatura text, cinturatriaje_cintura text, caderatriaje_cadera text, icctriaje_icc text, perimetrocuellotriaje_perimetro_cuello text, visioncercasincorregirod_v_cerca_s_od text, visioncercasincorregiroi_v_cerca_s_oi text, visioncercacorregidaod_v_cerca_c_od text, visioncercacorregidaoi_v_cerca_c_oi text, visionlejossincorregirod_v_lejos_s_od text, visionlejossincorregiroi_v_lejos_s_oi text, visionlejoscorregidaod_v_lejos_c_od text, visionlejoscorregidaoi_v_lejos_c_oi text, visionbinocular_v_binocular text, enfermedadesocularesoftalmo_e_oculares text, enfermedadesocularesotrosoftalmo_e_oculares1 text, ausentesodontograma_txtausentes integer, observacionesodontograma_txtobservaciones text, piezasmalestadoodontograma_txtpiezasmalestado integer, observacionesradiografiatorax_txtobservacionesrt text, observacioneslaboratorioclinico_txtobservacioneslb text, examenradiograficossanguineos_txtobservacionesrs text, glucosalaboratorioclinico_txtglucosabio text, vsglaboratorioclinico_txtvsg text, cocainalaboratorioclinico_txtcocaina text, marihuanalaboratorioclinico_txtmarihuana text, creatininalaboratorioclinico_txtcreatininabio text, oidoderecho500audiometria_o_d_500 text, oidoderecho1000audiometria_o_d_1000 text, oidoderecho2000audiometria_o_d_2000 text, oidoderecho3000audiometria_o_d_3000 text, oidoderecho4000audiometria_o_d_4000 text, oidoderecho6000audiometria_o_d_6000 text, oidoderecho8000audiometria_o_d_8000 text, oidoizquierdo500audiometria_o_i_500 text, oidoizquierdo1000audiometria_o_i_1000 text, oidoizquierdo2000audiometria_o_i_2000 text, oidoizquierdo3000audiometria_o_i_3000 text, oidoizquierdo4000audiometria_o_i_4000 text, oidoizquierdo6000audiometria_o_i_6000 text, oidoizquierdo8000audiometria_o_i_8000 text, diagnosticoaudiometricocompleto_diagnostico text, normalaudiometria_chkdnormal boolean, traumaleveodaudiometria_chkdtaleveod boolean, traumaleveoiaudiometria_chkdtaleveoi boolean, traumaavanzadoodaudiometria_chkdtaavanzadood boolean, traumaavanzadooiaudiometria_chkdtaavanzadooi boolean, hipoacusialeveodaudiometria_chkdhrleveod boolean, hipoacusialeveoiaudiometria_chkdhrleveoi boolean, hipoacusiamoderadaodaudiometria_chkdhrmoderadood boolean, hipoacusiamoderadaoiaudiometria_chkdhrmoderadooi boolean, hipoacusiaavanzadaodaudiometria_chkdhravanzadaod boolean, hipoacusiaavanzadaoiaudiometria_chkdhravanzadaoi boolean, otrashipoacusiasaudiometria_chkotrashipoacusias boolean, otrashipoacusiasaudiometria_txtotrashipoacusias text, fvcfuncionrespiratoria_fvc text, fev1funcionrespiratoria_fev1 text, fev1fvcfuncionrespiratoria_fev1fvc text, fef2575funcionrespiratoria_fef25_75 text, interpretacionfuncionrespiratoria_interpretacion text, fechaanexo7c_fecha date,
ruidoanexo7c_chkruido boolean, polvoanexo7c_chkpolvo boolean, vidsegmentarioanexo7c_chkvidsegmentario boolean, 
  vidtotalanexo7c_chkvidtotal boolean, cancerigenosanexo7c_chkcancerigenos boolean, mutagenicosanexo7c_chkmutagenicos boolean,
  solventesanexo7c_chksolventes boolean, metalesanexo7c_chkmetales boolean, temperaturaanexo7c_chktemperatura boolean, 
  biologicosanexo7c_chkbiologicos boolean, posturasanexo7c_chkposturas boolean, turnosanexo7c_chkturnos boolean, 
  cargasanexo7c_chkcargas boolean, movrepetanexo7c_chkmovrepet boolean, pvdanexo7c_chkpvd boolean,
  electricosanexo7c_electricos boolean, vibracionesanexo7c_vibraciones boolean, otrosanexo7c_chkotros boolean,
  alturaestructuraanexo7c_altura_estructura boolean, alturageograficaanexo7c_altura_geog boolean, quimicosanexo7c_quimicos boolean, reubicacionsianexo7c_tbrsi boolean, reubicacionnoanexo7c_rbrno boolean, tabaconadaaexo7c_chktnada boolean, tabacopocoanexo7c_chktpoco boolean, 
  tabacohabitualanexo7c_chkthabitual boolean, tabacoexcesivoanexo7c_chktexcesivo boolean, alcoholnadaanexo7c_chkanada boolean, alcoholpocoanexo7c_chkapoco boolean, alcoholhabitualanexo7c_chkahabitual boolean, alcoholexcesivoanexo7c_chkaexcesivo boolean, drogasnadaanexo7c_chkdnada boolean, 
  drogaspocoanexo7c_chkdpoco boolean, drogashabitualanexo7c_chkdhabitual boolean, drogasexcesivoanexo7c_chkdexcesivo boolean, puestoactualanexo7c_txtpuestoactual text, tiempoanexo7c_txttiempo text, antecedentespersonalesanexo7c_txtantecedentespersonales text, 
  antecedentespersonales2anexo7c_txtantecedentespersonales2 text, antecedentesfamiliaresanexo7c_txtantecedentesfamiliares text, cabezaanexo7c_txtcabeza text, narizanexo7c_txtnariz text, cuelloanexo7c_txtcuello text, perimetroanexo7c_txtperimetro text, baflanexo7c_txtb_a_f_l text, 
  visioncoloresanexo7c_txtvisioncolores text, enfermedadesocularesanexo7c_txtenfermedadesoculares text, diagnosticoaudioanexo7c_txtdiagnosticoaudio text, enfermedadesoculares2anexo7c_txtenfermedadesoculares2 text, reflejospupilaresanexo7c_txtreflejospupilares text, binocularanexo7c_txtbinocular text, 
  odanexo7c_txtod text, oianexo7c_txtoi text, toraxanexo7c_txttorax text, corazonanexo7c_txtcorazon text, pulmonesnormalanexo7c_rbnormal boolean, pulmonesanormalanexo7c_rbanormal boolean, pulmonesdescripcionanexo7c_txtpulmones text, miembrossuperioresanexo7c_txtmiembrossuperiores text, 
  miembrosinferioresanexo7c_txtmiembrosinferiores text, reflejososteotendinososanexo7c_txtreflejososteotendinosos text, marchaanexo7c_txtmarcha text, columnavertebralanexo7c_txtcolumnavertebral text, abdomenanexo7c_txtabdomen text, anillosinguinalesanexo7c_txtanillosinguinales text, 
  organosgenitalesanexo7c_txtorganosgenitales text, tactorectalnohizoanexo7c_rbtnohizo boolean, tactorectalnormalanexo7c_rbtnormal boolean, tactorectalanormalanexo7c_rbtanormal boolean, describirobservacionanexo7c_chkdescribirobservacion boolean, herniasanexo7c_txthernias text, 
  varicesanexo7c_txtvarices text, gangliosanexo7c_txtganglios text, lenguageanexo7c_txtlenguage text, observacionesfichamedicaanexo7c_txtobservacionesfm text, conclusionanexo7c_txtconclusion text, tetanoanexo7c_tetano boolean, hepatitisbanexo7c_hepatitisb boolean, 
  fiebreamarillaanexo7c_fiebreamarilla boolean, diagnosticoaudio2anexo7c_txtdiagnosticoaudio text, conclusionmedicoanexo7c_txtconclusionmed text, estadomentalanexo7c_txtestadomental text, anamnesisanexo7c_txtanamnesis text,
...
drop FUNCTION obtener_reporte_antecedentes_patologicos(
    IN p_norden integer,
    IN name_service text)
...
CREATE OR REPLACE FUNCTION obtener_reporte_antecedentes_patologicos(
    IN p_norden integer,
    IN name_service text)
  RETURNS TABLE(dni_cod_pa integer, nombres_nombres_pa text, apellidos_apellidos_pa text, direccionpaciente_direccion_pa text, sexo_sexo_pa "char", fechanacimientopaciente_fecha_nacimiento_pa date, cargo_cargo_de text, area_area_o text, contrata_razon_contrata text, n_orden integer, 
  empresa_razon_empresa text, edad_edad text, color integer, codigoantecedentespatologicos_cod_ap integer, fechaantecedentespatologicos_fecha_ap date, dniusuario_dni_user integer, alergias_chk1 boolean, amigdalitiscronica_chk2 boolean, arritmiascardiacas_chk3 boolean, asma_chk4 boolean, 
  bocio_chk5 boolean, bronconeumonia_chk6 boolean, bronquitisarepeticion_chk7 boolean, cariesogingivitis_chk8 boolean, colecistitis_chk9 boolean, dermatitis_chk10 boolean, diabetes_chk11 boolean, disenteria_chk12 boolean, enfermedadescorazon_chk13 boolean, enfermedadesoculares_chk14 boolean, 
  epilsepsiaoconvulsiones_chk15 boolean, faringitiscronica_chk16 boolean, fiebremalta_chk17 boolean, fiebretifoidea_chk18 boolean, fiebrereumatica_chk19 boolean, foruncolois_chk20 boolean, gastritiscronica_chk21 boolean, gonorrea_chk22 boolean, gota_chk23 boolean, hemorroides_chk24 boolean, 
  hepatitis_chk25 boolean, hernias_chk26 boolean, hipertencionarterial_chk27 boolean, urinariasrepetidas_chk28 boolean, intoxicaciones_chk29 boolean, insuficienciacardiaca_chk30 boolean, insuficienciacoronariacronica_chk31 boolean, insuficienciarenalcronica_chk32 boolean, litiasisurinaria_chk33 boolean, 
  meningitis_chk34 boolean, neuritis_chk35 boolean, otitismedia_chk36 boolean, presionaltaobaja_chk37 boolean, paludismoomalaria_chk38 boolean, parasitosisintestinal_chk39 boolean, paratiditis_chk40 boolean, pleuresia_chk41 boolean, plumbismo_chk42 boolean, poliomielitis_chk43 boolean, 
  portadormarcapasos_chk44 boolean, protesiscardiacasvalvulares_chk45 boolean, resfriosfrecuentes_chk46 boolean, reumatismo_chk47 boolean, sarampion_chk48 boolean, sifilis_chk49 boolean, silicosis_chk50 boolean, sinusitiscronica_chk51 boolean, tosconvulsiva_chk52 boolean, transtornosnerviosos_chk53 boolean, 
  traumatismoencefalocraneano_chk54 boolean, tuberculosis_chk55 boolean, tumoresquistes_chk56 boolean, ulcerapeptica_chk57 boolean, varicela_chk58 boolean, varices_chk59 boolean, varicocele_chk60 boolean, perdidamemoria_chk61 boolean, preocupacionesangustia_chk62 boolean, doloresarticulares_chk63 boolean, 
  aumentodisminucionpeso_chk64 boolean, dolorcabeza_chk65 boolean, diarrea_chk66 boolean, agitacionejercicio_chk67 boolean, dolorocular_chk68 boolean, doloropresivotorax_chk69 boolean, hinchazonpiesomanos_chk70 boolean, estrenimiento_chk71 boolean, vomitosconsangre_chk72 boolean, sangradopororina_chk73 boolean, 
  tosconsangre_chk74 boolean, coloracionamarrillapiel_chk75 boolean, indigestionfrecuente_chk76 boolean, insomnio_chk77 boolean, lumbalgiaodolorcintura_chk78 boolean, mareos_chk79 boolean, hecesnegras_chk80 boolean, orinacondolor_chk81 boolean, orinainvoluntaria_chk82 boolean, doloroido_chk83 boolean, 
  secrecionesoido_chk84 boolean, palpitaciones_chk85 boolean, adormecimientos_chk86 boolean, pesadillasfrecuentes_chk87 boolean, doloresmusculares_chk88 boolean, toscronica_chk89 boolean, sangradoencias_chk90 boolean, drogasno_rbdrogasno boolean, drogassi_rbdrogassi boolean, licorno_rblicorno boolean, 
  licorsi_rblicorsi boolean, fumarno_rbfumarno boolean, fumarsi_rbfumarsi boolean, drogasfrecuencia_txtdrogasfrecuencia text, drogastipo_txtdrogastipo text, licorfrecuencia_txtlicorfrecuencia text, licortipofrecuente_txtlicortipofrecuente text, numerocigarrillos_txtncigarrillos text, 
  precisarcausasvarones_txtvcausas text, hijosvivosvarones_txtvhijosvivos text, hijosfallecidosvarones_txtvhijosfallecidos text, abortosparejasvarones_txtvnabortosparejas text, iniciomestruaciondamas_txtdiniciomestruacion text, iniciovidasexualdamas_txtdiniciovidasexual text, 
  numeroparejassexactualidaddamas_txtdnumparejassexactualidad text, hijosvivosdamas_txtdhijosvivos text, hijosfallecidosdamas_txtdhijosfallecidos text, numerosdeabortosdamas_txtdnumerosdeabortos text, precisarcausasdamas_txtdcausas text, otrosdescripcionantecedentespatologicos_txtotrosap text, 
  otrosdescripcionindicarenfermedades_txtotros1ap text, covid_chkcovid boolean, fechacovid_fechacovid date, covidlevel_chkcovidl boolean, covidmoderado_chkcovidm boolean, covidsevero_chkcovids boolean, dosisvacunas_txtdosis text, userregistro_user_registro text, otrostipoindicarenfermedades_txtotros text, 
  otrosfrecuenciaindicarenfermedades_txtotrosfrecuencia text, otrossiindicarenfermedades_rbotrossi boolean, otrosnoindicarenfermedades_rbotrosno boolean, imaboro_ima boolean, acvboro_acv boolean, tbcboro_tbc boolean, vihboro_vih boolean, fobiasboro_fobias boolean, vertigosboro_vertigos boolean, 
  tifoideaboro_tifoidea boolean, neoplasiasboro_neoplasias boolean, quemadurasboro_quemaduras boolean, discopatiasboro_discopatias boolean, columnaboro_columna boolean, enfermedadespsiquiatricasboro_enf_psiquiatricas boolean, enfermedadesreumaticasboro_enf_reumatica boolean, 
  enfermedadespulmonaresboro_enf_pulmonares boolean, enfermedadespielboro_enf_piel boolean, tendinitisboro_tendinitis boolean, onicomicosisboro_onicomicosis boolean, fracturasboro_fracturas boolean, anemiaboro_anemia boolean, obesidadboro_obesidad boolean, dislipidemiaboro_dislipidemia boolean, 
  intoxicacionesboro_intoxicaciones boolean, amputacionboro_amputacion boolean, sorderaboro_sordera boolean, especifiquetratamientoboro_especifique_detalleenfermedades text, alergiasalimentosboro_alergias_medic_alim boolean, alergiasalimentosespecifiqueboro_alergias_medic_alimdetall text, 
  accidentetrabajoboro_accitrabajo boolean, accidentetrabajofechaboro_accit_fecha date, descansomedicoboro_accit_descanso boolean, descansomedicoespecifiqueboro_accit_descanso_detal text, enfermedadesprofesionalesboro_enfe_prof boolean, enfermedadesprofesionalesfechaboro_enfe_profecha date, 
  enfermedadeslaboralescalificacionboro_enfe_lab_calif boolean, enfermedadeslaboralesespecifiqueboro_enfe_lab_califdetal text, antitetanicaboro_antitetanica boolean, fiebreamarillaboro_fiebre_amarilla boolean, influenzaboro_influenza boolean, hepatitisaboro_hepatitisa boolean, 
  hepatitisbboro_hepatitisb boolean, gripeinfluenzaboro_gripe_influenza boolean, neumococoboro_neumococo boolean, rabiaboro_rabia boolean, papilomahumanoboro_papiloma_humano boolean, cantidosisboro_cantidosis boolean, medicamentoboro_medicamento boolean, 
  medicamentoespecifiqueboro_medicamento_detal text, actividadfisicaboro_activ_fisic boolean, actividadfisicaespecifiqueboro_activ_fisic_detal text, padreespecifiqueboro_padre_detall text, madreespecifiqueboro_madre_detall text, hermanosespecifiqueboro_hermanos_detall text, 
  hijosespecifiqueboro_hijos_detall text, esposconyespecifiqueboro_espos_cony_detall text, conadisespecifiqueboro_conadisdetalle text, etsboro_ets boolean, migranaboro_migrana boolean, tiempoincapacidadboro_timeincapacidad text, enfermedadesocularesoftalmo_e_oculares text, 
  enfermedadesocularesotrosoftalmo_e_oculares1 text, visioncercasincorregirod_v_cerca_s_od text, visioncercasincorregiroi_v_cerca_s_oi text, oftalodccmologia_odcc text, oiccoftalmologia_oicc text, visionlejossincorregirod_v_lejos_s_od text, visionlejossincorregiroi_v_lejos_s_oi text, 
  odlcoftalmologia_odlc text, oilcoftalmologia_oilc text, vcoftalmologia_vc text, vboftalmologia_vb text, rpoftalmologia_rp text, ruidoanexo7c_chkruido boolean, polvoanexo7c_chkpolvo boolean, vidsegmentarioanexo7c_chkvidsegmentario boolean, 
  vidtotalanexo7c_chkvidtotal boolean, cancerigenosanexo7c_chkcancerigenos boolean, mutagenicosanexo7c_chkmutagenicos boolean,
  solventesanexo7c_chksolventes boolean, metalesanexo7c_chkmetales boolean, temperaturaanexo7c_chktemperatura boolean, 
  biologicosanexo7c_chkbiologicos boolean, posturasanexo7c_chkposturas boolean, turnosanexo7c_chkturnos boolean, 
  cargasanexo7c_chkcargas boolean, movrepetanexo7c_chkmovrepet boolean, pvdanexo7c_chkpvd boolean,
  electricosanexo7c_electricos boolean, vibracionesanexo7c_vibraciones boolean, otrosanexo7c_chkotros boolean,
  alturaestructuraanexo7c_altura_estructura boolean, alturageograficaanexo7c_altura_geog boolean, quimicosanexo7c_quimicos boolean, cocainalaboratorioclinico_txtcocaina text, marihuanalaboratorioclinico_txtmarihuana text, direccionsede text, sede text, nombresede text, namejasper text, esboro boolean) AS
$BODY$
BEGIN
    RETURN QUERY
	SELECT 
