...
CREATE TABLE panel4d ( id SERIAL PRIMARY KEY, n_orden BIGINT NOT NULL UNIQUE, cocaina BOOLEAN, marihuana BOOLEAN, opiaceos BOOLEAN, metanfetamina BOOLEAN, CONSTRAINT fk_n_orden FOREIGN KEY (n_orden) REFERENCES n_orden_ocupacional (n_orden) );
